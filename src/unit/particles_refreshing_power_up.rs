...
pub struct ParticlesRefreshingPowerUp {
    unit: RefreshingPowerUpData,
}

impl ParticlesRefreshingPowerUp {
    pub fn from_reader(connector: &Arc<Connector>, universe_group: &UniverseGroup, packet: &Packet, reader: &mut BinaryReader) -> Result<ParticlesRefreshingPowerUp, Error> {
        Ok(ParticlesRefreshingPowerUp {
...
impl Unit for ParticlesRefreshingPowerUp {
    fn name(&self) -> &str {
        self.unit.name()
    }
...
// TODO replace with delegation directive
// once standardized: https://github.com/rust-lang/rfcs/pull/1406
impl PowerUp for ParticlesRefreshingPowerUp {

}

// TODO replace with delegation directive
// once standardized: https://github.com/rust-lang/rfcs/pull/1406
impl RefreshingPowerUp for ParticlesRefreshingPowerUp {
    fn amount(&self) -> f32 {
        self.unit.amount()
    }
}