...
pub struct ShieldRefreshingPowerUp {
    unit: RefreshingPowerUpData,
}

impl ShieldRefreshingPowerUp {
    pub fn from_reader(connector: &Arc<Connector>, universe_group: &UniverseGroup, packet: &Packet, reader: &mut BinaryReader) -> Result<ShieldRefreshingPowerUp, Error> {
        Ok(ShieldRefreshingPowerUp {
...
impl Unit for ShieldRefreshingPowerUp {
    fn name(&self) -> &str {
        self.unit.name()
    }
...
// TODO replace with delegation directive
// once standardized: https://github.com/rust-lang/rfcs/pull/1406
impl PowerUp for ShieldRefreshingPowerUp {

}

// TODO replace with delegation directive
// once standardized: https://github.com/rust-lang/rfcs/pull/1406
impl RefreshingPowerUp for ShieldRefreshingPowerUp {
    fn amount(&self) -> f32 {
        self.unit.amount()
    }
}