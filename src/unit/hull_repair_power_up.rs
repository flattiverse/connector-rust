...
impl UnitCastTable for HullRepairPowerUp {
    cast_fn!(steady_unit_cast_fn, HullRepairPowerUp, dyn SteadyUnit);
    cast_fn!(power_up_cast_fn, HullRepairPowerUp, dyn PowerUp);
}
