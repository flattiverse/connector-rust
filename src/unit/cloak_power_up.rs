...
pub struct CloakPowerUp {
    unit:   PowerUpData,
}

impl CloakPowerUp {
    pub fn from_reader(connector: &Arc<Connector>, universe_group: &UniverseGroup, packet: &Packet, reader: &mut BinaryReader) -> Result<CloakPowerUp, Error> {
        Ok(CloakPowerUp {
