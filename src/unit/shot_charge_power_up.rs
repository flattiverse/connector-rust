...
impl UnitCastTable for ShotChargePowerUp {
    cast_fn!(steady_unit_cast_fn, ShotChargePowerUp, dyn SteadyUnit);
    cast_fn!(power_up_cast_fn, ShotChargePowerUp, dyn PowerUp);
}
