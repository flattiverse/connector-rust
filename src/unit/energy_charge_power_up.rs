...
impl UnitCastTable for EnergyChargePowerUp {
    cast_fn!(steady_unit_cast_fn, EnergyChargePowerUp, dyn SteadyUnit);
    cast_fn!(power_up_cast_fn, EnergyChargePowerUp, dyn PowerUp);
}
