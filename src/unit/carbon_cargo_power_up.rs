...
impl UnitCastTable for CarbonCargoPowerUp {
    cast_fn!(steady_unit_cast_fn, CarbonCargoPowerUp, dyn SteadyUnit);
    cast_fn!(power_up_cast_fn, CarbonCargoPowerUp, dyn PowerUp);
}
