...
impl UnitCastTable for NeutrinoChargePowerUp {
    cast_fn!(steady_unit_cast_fn, NeutrinoChargePowerUp, dyn SteadyUnit);
    cast_fn!(power_up_cast_fn, NeutrinoChargePowerUp, dyn PowerUp);
}
